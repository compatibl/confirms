...
from confirms.core.schedule.payment_schedule import PaymentSchedule


@dataclass
class InterestSchedule(PaymentSchedule):
    """Interest schedule adds unadjusted and adjusted accrual start and end dates to PaymentSchedule."""
